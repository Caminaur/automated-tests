...
void main() {
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      await tester.pumpWidget(createWidgetUnderTest());
      await tester
          .pump(const Duration(milliseconds: 500)); // forces a widget rebuild
      expect(find.byType(CircularProgressIndicator), findsOneWidget);
      await tester
          .pumpAndSettle(); // waits until there are no more rebuilds happening (animations for example)
    },
  );
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      await tester.pump(); // here we just trigger another rebuild
